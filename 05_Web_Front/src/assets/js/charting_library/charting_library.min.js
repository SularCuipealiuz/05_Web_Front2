(function () {
  ...
  function k() {
    var a, b, c, e, d, f = arguments[0] || {}, h = 1, g = arguments.length, l = !1;
    "boolean" === typeof f && (l = f, f = arguments[h] || {}, h++);
    "object" !== typeof f && "function" !== typeof f && (f = {});
    h === g && (f = this, h--);
    for (; h < g; h++) if (null != (a = arguments[h])) for (b in a) c = f[b], e = a[b], f !== e && (l && e &&
  ...
  if (!window.TradingView) {
    var n = {
      ...
      BARS: 0, CANDLES: 1,
      LINE: 2, AREA: 3, HEIKEN_ASHI: 8, HOLLOW_CANDLES: 9, version: function () {
        ...
        var b = {
          ...
          time_frames: [{text: "5y", resolution: "W"}, {text: "1y", resolution: "W"}, {
            text: "6m",
            resolution: "120"
          }, {text: "3m", resolution: "60"}, {text: "1m", resolution: "30"}, {text: "5d", resolution: "5"}, {
            text: "1d",
            resolution: "1"
          }],
          client_id: "0",
    ...
    d.widget.prototype =
      {
        _innerWindow: function () {
          ...
          this.options.fullscreen ? "" : ' width="' + this.options.width + '" height="' + this.options.height + '"') + ' frameborder="0" allowTransparency="true" scrolling="no" allowfullscreen style="display:block;background: rgb(25, 35, 48);"></iframe>'
        ...
        createStudyTemplate: function (a, b) {
          ...
          this._innerWindow().tradingViewApi.loadChart({json: a, extendedData: b})
    ...
    g("onSymbolChange");
    g("onIntervalChange");
    [["onTick"], ["onAutoSaveNeeded"], ["onScreenshotReady"], ["onBarMarkClicked", "onMarkClick"], ["onTimescaleMarkClicked", "onTimescaleMarkClick"]].forEach(function (a) {
