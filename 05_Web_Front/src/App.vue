      ...
      <div class="layout">
        <div class="layout-ceiling">
          ...
          <div class="layout-ceiling-main">
            ...
            <div class="header_nav">
              <Menu :active-name="activeNav" width="auto" :open-names="['1']">
                <Submenu name="1">
                  ...
                  <router-link to="/exchangeForSecond">
                    <MenuItem name="nav-exchange-for-second">{{$t("header.exchangeForSecond")}}</MenuItem>
                  </router-link>
                  <router-link to="/ctc">
            ...
            <div class="header_nav_mobile_triggle" @click="toggleMenu()">
    ...
    <Drawer :closable="true" width="40" v-model="navDrawerModal" class="header_nav_mobile">
      <Menu :active-name="activeNav" width="auto" @on-select="changelanguage">
        ...
        <Submenu name="nav-login" id="login_register_theme" v-if="!isLogin">
          ...
          <router-link to="/login" id="login">
            <MenuItem name="1-1" class="lang-item" style="padding-left:20px!important;">{{$t("common.login")}}
            </MenuItem>
          </router-link>
          <router-link to="/register" id="register">
            <MenuItem name="1-2" class="lang-item" style="padding-left:20px!important;">{{$t("common.register")}}
            </MenuItem>
          </router-link>
        </Submenu>
        ...
        <Submenu name="lang">
          ...
          <MenuItem name="zh" class="lang-item" style="padding-left:20px!important;"><img
              src="./assets/images/lang-zh.png"></img>简体中文
          </MenuItem>
          <MenuItem name="en" class="lang-item" style="padding-left:20px!important;"><img
              src="./assets/images/lang-en.png"></img>ENGLISH
          </MenuItem>
        </Submenu>
        <router-link to="/app">
          <MenuItem name="nav-appdownload" style="text-align:left;color:#bdc2ca;">{{$t("header.appdownlaod")}}
          </MenuItem>
        </router-link>
      </Menu>
    </Drawer>
      ...
      <div class="footer_content">
        ...
        <div class="footer_right">
          <ul>
            ...
            <li>
              <router-link target="_blank" to="/helpdetail?cate=6&id=39&cateTitle=其他">{{$t("footer.jrwm")}}
              </router-link>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=2&cateTitle=条款协议">{{$t("footer.mztk")}}
              </router-link>
            </li>
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=3&cateTitle=条款协议">{{$t("footer.ystk")}}
              </router-link>
            </li>
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=5&cateTitle=条款协议">{{$t("footer.fwtk")}}
              </router-link>
            </li>
            <li>
              <router-link target="_blank" to="/helpdetail?cate=5&id=38&cateTitle=条款协议">{{$t("footer.fltk")}}
              </router-link>
            </li>
          </ul>
          <ul>
  ...
  export default {
    ...
    methods: {
      ...
      initialize() {
        ...
        this.$store.commit("RECOVERY_MEMBER");
        this.$store.commit("INIT_LANG");
        this.$store.commit("INIT_LOGIN_TIMES");
        ...
        ws.onmessage = function (res) {
          ...
          if (resJson.action === 'welcome') {
            const payload = JSON.stringify({
              resource: "LoginClient",
              action: "signUp",
              data: {
                token: "jwt-token",
                uid: "106"
      ...
      changelanguage: function (name) {
        ...
        if (name == "en") {
          this.$store.commit("SET_LANG", "English");
          this.$i18n.locale = "en";
          this.reload();
        }
        if (name == "zh") {
          this.$store.commit("SET_LANG", "简体中文");
          this.$i18n.locale = "zh";
          this.reload();
        }
      }
